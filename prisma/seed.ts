...
async function main() {
  ...
  await prisma.user.upsert({
    ...
    create: {
      ...
      password: null,
      avatarUrl: getGravatarUrl("generic@example.com"),
    },
  });
  ...
  await prisma.user.upsert({
    ...
    create: {
      ...
      password: await hashPassword("team123"),
  ...
  await prisma.user.upsert({
    ...
    create: {
      ...
      avatarUrl: getGravatarUrl("admin@example.com"), // <== Add this
    },
  });
  ...
  await prisma.user.upsert({
    ...
    create: {
      ...
      avatarUrl: getGravatarUrl("client@example.com"), // <== Add this
    },
  });
  ...
  const teamUser = await prisma.user.upsert({
    ...
    create: {
      ...
      userType: UserType.TEAM,
      password: await hashPassword("isaac123"),
      name: "Isaac Iglesias",
